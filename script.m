...
alphabet = [-1, 1] ; Tb = 1e-6 ; Ts = Tb * log2(length(alphabet));
nbits = 1000; 
nsymbols = nbits / log2(length(alphabet));
N0 = 1;
...
tx_signal = modulate(tx_symbols,Ts,nsymbols) ;% Received signal (channel output)
